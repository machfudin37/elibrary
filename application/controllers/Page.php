...
class Page extends CI_Controller
{
    ...
    public function login()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $user = $this->db->get_where('siswa', ['nama_siswa' => $nama_siswa])->row_array();
    ...
    public function profile()
    {
        ...
        $no_reg = $this->session->userdata('no_reg');
        $data['siswa'] = $this->m_transaksi->getSiswa($no_reg);
        $this->template->load('user/template', 'pages/profile', $data);
    }
}
