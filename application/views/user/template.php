    ...
    <div class="wrapper">
            ...
            <nav class="navbar navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        <a href="<?= base_url(); ?>" class="navbar-brand" style="margin-left: 0">E-Library</a>
                                ...
                                <li class="dropdown user user-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-footer">
                                            <div class="pull-left">
                                                <a href="<?= base_url('page/profile') ?>" class="btn btn-default btn-flat">Profile</a>
                                            </div>
        ...
        <footer class="main-footer">
            <div class="container">
                ...
                <strong>Copyright &copy; 2021 <a href="">E-Library</a>.</strong> All rights
                reserved.
            </div>
            <!-- /.container -->
        </footer>
