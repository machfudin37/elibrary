    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url('home') ?>" class="logo">
                ...
                <span class="logo-mini"><b>E-Library</b></span>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?= base_url('admin/list') ?>" class="btn btn-default btn-flat">Ubah Password</a>
                                    </div>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?= date('Y') ?> <a href="">E-Library</a>.</strong> All rights
            reserved.
        </footer>
    </div>
